...
const BallIcon: React.FC<{ color: string; name: string }> = ({ color, name }) => {
    // Basic circle SVG for all balls, we can customize if needed
    // But a simple circle with the ball's color is a good start and matches "svg representation"
    let ballColor = color;
    if (name === "Bowling") {
        ballColor = "red";
    }
    ...
    return (
        <svg width="30" height="30" style={{ marginRight: '8px', verticalAlign: 'middle' }} viewBox="0 0 20 20">
            <defs>
